...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get the views
        // DO (1) You'll probably want more than just the Button
    ...
    public void nextWord() {
        ...
        // DO (3) Go to the next word in the Cursor, show the next word and hide the definition
    ...
    protected void onDestroy() {
        super.onDestroy();
        // DO (5) Remember to close your cursor!
    }
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            mData.close();
            // DO (2) Initialize anything that you need the cursor for, such as setting up
