...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        String sharable = "hello, i am learning Android!";
        String mimeType = "text/plain";
        String title = "Choose an app to share the text!";
        ShareCompat.IntentBuilder.from(this).setChooserTitle(title).setType(mimeType).setText(sharable).startChooser();
